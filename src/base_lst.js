...
export default class BaseLst extends BasePrm {
	...
	getGenValue(props, generator, path) {
		...
		for (let i in theVal) {
			...
			ret.push(this.parseEachGenElement(element, i, props, generator, path));
		}
		return ret.join(props.seperator);
	}

	getAppendValue(props,generator,path) { return ""; }
			...
			<Fragment>
					...
					<RUI.Button
						...
						onAction={(val) => {
							...
							generator.setState(fp.set(generator.state, ["values", fnlPath], theAry));
						}}
						tooltip="Add Element"
						disabled={
				...
				<div className={styles['entry']}>
					<div className={styles['overview']}>
						...
						<div className={styles['info']}>
							...
							{this.props.hasOwnProperty("seperator") && (<div className={styles['param']}><span className={styles['label']}>Seperator:</span> <span className={styles['value']}>{this.props.seperator}</span></div>)}
