...
export default class LstInteger extends BaseLst {
	...
	getTypeName() { return "List (Integer)" }
	getTypeInfo(props) { return "A concatenation of integer values, typically seperated by commas, that usually is treated like an array server-side."; }
	getTypeExample(props) { return ('54'+props.seperator+'37'); }

	getSampleValue(props, override) { return "68"+props.seperator+"684" }
