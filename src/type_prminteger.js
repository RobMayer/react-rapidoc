...
export default class PrmInteger extends BasePrm {
	...
	getTypeName() { return "Integer" }
	getTypeInfo(props) { return "An integer or non-decimal number. Might have a minimum or maximum value. May also be required to be a multiple of a so-called 'step'."; }
	getTypeExample(props) { return 3; }

	getSampleValue(props, override) { return 3; }
