...
export default class AryInteger extends BaseAry {
	...
	getTypeName() { return "Array (Integer)" }
	getTypeInfo(props) { return "An array of integers. When used in Request/Response bodies, these will be JSON arrays. In URL parameters, empty brackets [] or indexed brackets [1] in the key will be used to denote array members. See the section example."; }
	getTypeExample(props) { return '[1,3]'; }

	getSampleValue(props, override) { return [1, 3]; }

	parseEachGenElement(element, i, props, generator, path) {
